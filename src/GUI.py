...
class App:
    ...
    def __init__(self):
        ...
        _title = "Arduino SC Interface (v0.3.2)"
    ...
    def feed_func(self):
        try:
            feed = TwittFeed.TwittFeed(self.urlEntry.get())
    ...
    def clear_func(self):
        ...
        SerialComunication.send_serial('#000000', self.portEntry.get(), self.rateEntry.get())
